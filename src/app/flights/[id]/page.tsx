...
const FlightDetailsPage = () => {
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex-grow flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="mb-6">The flight you are looking for does not exist or may have been removed.</p>
            <Button asChild>
  ...
  const controller = getControllerById(flight.assignedController);
  const tickets = getTicketsByFlight(flight.id);
        ...
        <div className="page-container">
          ...
          <div className="mb-8">
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {/* Flight Basic Info */}
                <div>
                  <h3 className="text-lg font-semibold mb-4 text-navy-800">Flight Information</h3>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <div className="font-medium">{durationHours}h {durationMinutes}m</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {/* Departure Info */}
                <div>
                  <h3 className="text-lg font-semibold mb-4 text-navy-800">Departure</h3>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <div className="font-medium">{departureAirport?.name} ({flight.departureAirport})</div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <div className="text-sm text-gray-500">Terminal & Gate</div>
                        <div className="font-medium">Terminal {flight.terminal}, Gate {flight.gate}</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {/* Arrival Info */}
                <div>
                  <h3 className="text-lg font-semibold mb-4 text-navy-800">Arrival</h3>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        <div className="text-sm text-gray-500">Airport</div>
                        <div className="font-medium">{arrivalAirport?.name} ({flight.arrivalAirport})</div>
          ...
          <Tabs defaultValue="route">
            <TabsList className="mb-6">
              ...
              <TabsTrigger value="controller">Air Traffic Controller</TabsTrigger>
              <TabsTrigger value="passengers">Passengers ({tickets.length})</TabsTrigger>
            </TabsList>
                ...
                <CardContent>
                  <div className="flex items-center justify-between">
                    <div className="text-center">
                      ...
                      <div className="text-sm text-gray-500">{departureAirport?.city}</div>
                    ...
                    <div className="flex-grow px-6 flex flex-col items-center">
                      ...
                      <div className="text-xs text-gray-500 mt-2">{durationHours}h {durationMinutes}m</div>
                    </div>
                    
                    <div className="text-center">
                      <div className="text-xl font-bold">{flight.arrivalAirport}</div>
                      <div className="text-sm text-gray-500">{arrivalAirport?.city}</div>
                      <div className="text-xs">{new Date(flight.arrivalTime).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}</div>
                    </div>
                  </div>
                    ...
                    <div className="flex flex-col md:flex-row items-start gap-6">
                      ...
                      <div className="space-y-4 flex-1">
                        <div>
                          ...
                          <div className="text-lg font-medium">{controller.name}</div>
                        </div>
                        
                        <div>
                          <div className="text-sm text-gray-500">Position</div>
                          <div className="font-medium">{controller.position}</div>
                        </div>
                        ...
                        <TableBody>
                          {tickets.map((ticket) => (
                            <TableRow key={ticket.id}>
                              <TableCell>
                                <div className="font-medium">Passenger #{ticket.passengerId}</div>
                              </TableCell>
                              <TableCell>
